      ...
      {session ? (
        ...
        <header className={`fixed top-0 left-0 right-0 z-10 transition duration-300 ease-in-out ${isScrolled ? 'bg-gray-800/80 backdrop-blur' : 'bg-gray-800'} text-white p-4 w-full`}>
          <div className="container mx-auto flex justify-between items-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="white"><path d="M8 6.983a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2zM7 12a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2H8a1 1 0 0 1-1-1m1 3.017a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2z"/><path fill-rule="evenodd" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10m-2 0a8 8 0 1 1-16 0a8 8 0 0 1 16 0" clip-rule="evenodd"/></g></svg>
            </button>
          <button
          ...
          {isMenuOpen && (
            <div className="md:hidden absolute top-full left-0 right-0 bg-gray-800 text-white p-4">
              <Link href="/collection" className="hover:text-gray-300 block">Collection</Link>
              <Link href="/shop" className="hover:text-gray-300 block">Boutique</Link>
